...
Фронтенд CRM-система на React с ролевым разграничением доступа (admin/user), JWT-аутентификацией с автоматическим обновлением токена и RTK Query для работы с API.
